...
function footerComponent()
{
   ...
   Footer.setAttribute("class" ,"d-flex justify-content-around align-items-center ");
   ...
   `;
    ...
    DesingServise.style.marginTop = "-80px";
